...
export const zh = {
  ...
  'settings.desktopEnabledHint': '保存后随当前 DSH Host 启动或关闭；网页宠物不受影响。',
  'settings.size': '大小（px）',
...
export const en = {
  ...
  'settings.desktopEnabledHint': 'After saving, starts or stops with this DSH Host without changing the web pet.',
