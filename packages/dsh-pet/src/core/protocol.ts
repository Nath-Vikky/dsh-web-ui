...
/** First activity protocol version. */
export const PET_ACTIVITY_PROTOCOL_VERSION = 1 as const
...
/** Full process-local snapshot. Version 1 deliberately does not use deltas. */
